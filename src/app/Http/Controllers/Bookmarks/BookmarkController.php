...
use App\Bookmark\UseCase\ShowBookmarkListPageUseCase;// 追加
use App\Http\Requests\CreateBookmarkRequest; // 追加
use App\Bookmark\UseCase\CreateBookmarkUseCase;// 追加
...
class BookmarkController extends Controller
{
    ...
    public function create(CreateBookmarkRequest $request)
    {
        ...
        $useCase = new CreateBookmarkUseCase(); // 47行目のlistメソッドのような書き方もできる
